...
import '../css/FAQPage.css'; // Import the CSS file
        ...
        <div class="accordion-container">
            <div class="accordion active">
                <div class="accordion-heading">
                    <h3 class="ques"> What is NovaWallet, and how can it help me manage my expenses?</h3>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How can I log in to my NovaWallet account?</h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">Can I view graphical representations of my spending on NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How do I get started with NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">Can I track expenses based on different time frames?
                    </h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How can I track my savings on NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">Can I manage due bills on NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How do I add expenses on NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How do I log out of my NovaWallet account?</h3>
                    <i class="fas fa-angle-down"></i>
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques"> How can I contact NovaWallet support
                    </h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">What should I do if I forget my NovaWallet password?</h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How do I split expenses with a group on NovaWallet?</h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How do I change my profile information on NovaWallet?
                    </h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
            ...
            <div class="accordion">
                <div class="accordion-heading">
                    <h3 class="ques">How can I download expense reports on NovaWallet?
                    </h3>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
